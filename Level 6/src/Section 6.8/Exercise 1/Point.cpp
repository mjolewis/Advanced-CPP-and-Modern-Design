...
std::shared_ptr<DistanceStrategy> Point::distanceStrategy{};
 ...
 * @param p The other Point whose coordinates will be used when calculating the distance between this Point
 * @return The distance between this Point and the specified Point
 */
double Point::distance(const Point &p) const
{
    return Point::distanceStrategy->distance(*this, p);
}
 ...
 * @note This uses the Strategy Pattern, which delegates the distance calculation to a specific DistanceStrategy
 * @param p The other Point whose coordinates will be used when calculating the distance between this Point
 * @param strategy A concrete Strategy whose implementation will determine how distance is calculated
 * @return The distance between this Point and the specified Point
 */
double Point::distance(const Point& p, const std::shared_ptr<DistanceStrategy>& strategy) const
{
    return strategy->distance(*this, p);
}
