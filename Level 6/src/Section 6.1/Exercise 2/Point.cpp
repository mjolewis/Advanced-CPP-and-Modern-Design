...
{
    return std::sqrt(std::pow((x - 0), 2) + std::pow(y - 0, 2));
}
...
/**
 * Create a string representation of this Point and return it.
...
std::string Point::toString() const
{
    ...
    return "Point(" + xCoordinateStream.str() + "," +  yCoordinateStream.str() + ")";
}
