 ...
 */
template<typename T, size_t N>
constexpr typename std::array<T, N>::iterator Vector<T, N>::begin() noexcept
{
    return array.begin();
}
 ...
 */
template<typename T, size_t N>
constexpr typename std::array<T, N>::iterator Vector<T, N>::end() noexcept
{
    return array.end();
}
 ...
 */
template<typename T, size_t N>
constexpr typename std::array<T, N>::const_iterator Vector<T, N>::begin() const noexcept
{
    return array.begin();
}
 ...
 */
template<typename T, size_t N>
constexpr typename std::array<T, N>::const_iterator Vector<T, N>::end() const noexcept
{
    return array.end();
}
 ...
 */
template<typename T, size_t N>
constexpr typename std::array<T, N>::const_iterator Vector<T, N>::cbegin() const noexcept
{
    return array.cbegin();
}
 ...
 */
template<typename T, size_t N>
constexpr typename std::array<T, N>::const_iterator Vector<T, N>::cend() const noexcept
{
    return array.cend();
}
