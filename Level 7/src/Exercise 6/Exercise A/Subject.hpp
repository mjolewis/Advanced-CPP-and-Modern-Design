...
public:
     ...
     * @param observerPtr The Observer no longer interested in receiving updates upon state changes
     */
    void detach(const ObserverPtr& observerPtr)
    {
        observers.remove(observerPtr);
    }
