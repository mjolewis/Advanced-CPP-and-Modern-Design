...
/**
 * Call operator used to convert Circle into a function object
 * @return A default Circle
 */
std::shared_ptr<Circle> Circle::operator()()
{
    std::cout << "Circle Function Object" << std::endl;
...
/**
 * Implements the Prototype pattern by creating a deep clone of this Circle
 * @return A deep clone of this Circle wrapped in a Shared Pointer
 */
