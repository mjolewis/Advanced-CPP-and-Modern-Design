...
/**
 * Call operator used to convert Line into a function object
 * @return A default Circle
 */
std::shared_ptr<Line> Line::operator()()
{
    std::cout << "Line Function Object" << std::endl;
...
/**
 * Implements the Prototype pattern by creating a deep clone of this Line
 * @return A deep clone of this Line wrapped in a Shared Pointer
 */
